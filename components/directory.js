  ...
  return (
    <> 
      <ul id="menu" className={styles.menu}>
        ...
        <li data-connected="true" data-current={ widgets == "freedom" ? 'true' : 'false' }>
          <Link className="anchor" href="/freedom">
            <a>{lock}<span>fr33d0m.mp4</span>{arrow}</a>
          </Link>
        </li>
        <li><a href="./assets/docs/add.pdf" rel="noreferrer" target="_blank"><span>add.pdf</span></a></li>
      </ul>
    </>
  )
}