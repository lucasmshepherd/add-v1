    ...
    <>
      ...
      <div className={styles.split}>
        ...
        <div className={styles.content}>
          ...
          <p><big>The government stood idly by while millions of hardworking individuals suffered.<br/><br/><b>All the while, the rich got richer.</b></big></p>
      ...
      <div className={styles.manifoot}>
        <p><big>We believe that there is a path forward. It requires us ALL to cause a little bit of anarchy. We must be vigilant in our mission; we must trust the process. Join our DAO. We would love to hear from you.</big></p>
